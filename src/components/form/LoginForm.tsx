...
export function LoginForm() {
  ...
  return (
    <div className="flex justify-center mb-8 items-center sm:p-4 px-8">
      <form onSubmit={handleSubmit} className="bg-transparent/60 border-green-300 login-gradient-green p-8 rounded-lg shadow-md w-full max-w-sm self-center">
        <div className="mb-4">
