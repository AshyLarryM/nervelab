    ...
    return (
        <div className="mt-6 mb-12 max-w-[300px] md:max-w-[500px] lg:max-w-none rounded-lg gradient-greeting px-4 py-8 md:mt-2 md:mb-16 md:px-16 md:py-12">
            <div className="text-center">
                ...
                <p className="text-white font-medium text-md md:text-2xl mb-3 text-glow-cyan">Sign in with USERNAME: <span className="text-glow">JohnDoe@nervelabs.com</span></p>
                <p className="text-white font-medium text-md md:text-2xl text-glow-cyan">Password: <span className="text-glow">J8!x4F@2LbZ#9kPm</span></p>
            </div>
        </div>
    )
}
